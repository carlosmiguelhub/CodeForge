    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-ink-muted text-center text-xs">
          Haven&rsquo;t verified your email yet? Enter your email and password
          above and click Sign in anyway &mdash; you&rsquo;ll be taken to a page
          where you can resend the verification link.
        </p>
        <p className="text-ink-muted text-center text-xs">
          Need an account?{" "}
          <a
